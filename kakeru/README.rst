...
::
   ...
   $ make apply TO=_kakeru

VPC, サブネット, バケットなどが作られる
...
sunrise2018/kakeru/provisioning/ami/packer.json の以下の部分を環境に合わせて変更する。
...
::
   ...
   $ cd ${sunrise2018}/kakeru/provisioning/ami
   $ make
